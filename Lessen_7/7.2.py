...
#
#     def short_name(self):
#         last_name, first_name = self.full_name.split()
...
#
#     def new_salary(self):
#         letter_counter = Counter("".join(self.departments))
#         top_letters = letter_counter.most_common(3)
#         total_count = sum(count for letter, count in top_letters)
